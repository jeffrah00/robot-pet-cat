...
Checklist of every external service this project depends on. Four accounts
total — Cloudflare R2 was dropped after the architecture pivot (we no longer
need bulk video storage).
