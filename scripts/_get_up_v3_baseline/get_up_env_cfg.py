...
def make_get_up_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  events = {
    "reset_to_fallen_pose": EventTermCfg(
            func=get_up_mdp.reset_to_random_fallen_pose,
            mode="reset",
        ),
  ...
  rewards = {
    ...
    "base_height_recovery": RewardTermCfg(
            func=get_up_mdp.base_height_recovery,
            weight=8.0,
            params={"target_height": 0.27},
        ),
        "upright_orientation": RewardTermCfg(
            func=get_up_mdp.upright_orientation,
            weight=5.0,
        ),
        ...
        "joint_velocity_penalty": RewardTermCfg(
            func=get_up_mdp.joint_velocity_penalty,
            weight=-0.001,
        ),
        "time_penalty": RewardTermCfg(
            func=get_up_mdp.time_penalty,
            weight=-0.05,
        ),
  }
