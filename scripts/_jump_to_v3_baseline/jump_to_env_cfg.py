...
from . import mdp as jump_to_mdp
...
def make_jump_to_env_cfg() -> ManagerBasedRlEnvCfg:
  ...
  rewards = {
    ...
    "action_rate_l2": RewardTermCfg(func=mdp.action_rate_l2, weight=-0.05),
                "approach_couch": RewardTermCfg(
            func=jump_to_mdp.approach_couch,
            weight=5.0,
        ),
        "velocity_toward_couch": RewardTermCfg(
            func=jump_to_mdp.velocity_toward_couch,
            weight=20.0,
        ),
        "height_apex": RewardTermCfg(
            func=jump_to_mdp.height_apex,
            weight=3.0,
        ),
        "on_couch_xy": RewardTermCfg(
            func=jump_to_mdp.on_couch_xy,
            weight=2.0,
        ),
        ...
        "joint_velocity_penalty": RewardTermCfg(
            func=jump_to_mdp.joint_velocity_penalty,
            weight=-0.001,
        ),
        "time_penalty": RewardTermCfg(
            func=jump_to_mdp.time_penalty,
            weight=-0.05,
        ),
  }
  ...
  return ManagerBasedRlEnvCfg(
    scene=SceneCfg(
      ...
      num_envs=1,
      extent=2.0,
      spec_fn=jump_to_mdp.add_couch_spec_fn,
    ),
