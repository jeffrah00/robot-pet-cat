...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{0.24\linewidth}
    \includegraphics[width=\linewidth]{figures/frame_v5_6s.png}
    \caption{\texttt{stay}}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.24\linewidth}
    \includegraphics[width=\linewidth]{figures/frame_v5_8s.png}
    \caption{\texttt{walk}}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.24\linewidth}
    \includegraphics[width=\linewidth]{figures/frame_v5_10s.png}
    \caption{\texttt{crouch}}
  \end{subfigure}\hfill
  \begin{subfigure}[b]{0.24\linewidth}
    \includegraphics[width=\linewidth]{figures/frame_v5_12s.png}
    \caption{\texttt{lie\_belly}}
  \end{subfigure}
  \caption{The four skills in the MuJoCo household scene. Frames sampled from
  a 5-minute autonomous brain rollout (\texttt{brain3d\_random\_5min.mp4}).
  Debug overlay is visible in simulation only.}
  \label{fig:skills}
\end{figure}
